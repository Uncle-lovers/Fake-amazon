...
prodlist=[("ALPHA","7,499"),("TAPTIME","10,000"),("JHOSHLET","10000"),("PORTCOMP","65000"),("EECHO BOX","2,500"),("GLAREELS","7599")] #names of products
...
Rishikeswaran V""")
        ...
        helpbutt=tk.Button(frame,text="Help",font="Roboto 15",bg=buttoncol,fg="black",command=lambda:helpinfo())
        helpbutt.place(relx=0.004,rely=0.11,relwidth=0.10,relheight=0.04) #places button in the window
...
class adminpg(): #become bezos
    def __init__(self):
        ...
        sop1=tk.Radiobutton(frame,text="Search By Name",variable=sop,value=1,bg=labelcol,fg="#737373")
        sop1.place(relx=0.1,rely=0.21)

        sop2=tk.Radiobutton(frame,text="Search By Product",variable=sop,value=2,bg=labelcol,fg="#737373")
        sop2.place(relx=0.3,rely=0.21)

        sop3=tk.Radiobutton(frame,text="Search By Price(greater than)",variable=sop,value=3,bg=labelcol,fg="#737373")
        sop3.place(relx=0.5,rely=0.21)

        sop4=tk.Radiobutton(frame,text="Search By Address",variable=sop,value=4,bg=labelcol,fg="#737373")
        sop4.place(relx=0.7,rely=0.21)

        sop5=tk.Radiobutton(frame,text="Search By Phone No",variable=sop,value=5,bg=labelcol,fg="#737373")
        sop5.place(relx=0.1,rely=0.25)

        sop6=tk.Radiobutton(frame,text="Raw sql query",variable=sop,value=6,bg=labelcol,fg="#737373")
...
class itempg():
    def __init__(self,itemno):
        ...
        desclabel=tk.Label(frame,text=f"{proddesc}",justify='left',font="Roboto 15",wraplength=500,bg="black",fg="white")                    
        desclabel.place(relx=0.5,rely=0.31,relwidth=0.5,relheight=0.45)

        global pimage   #prevents image from being garbage collected

        pimage = tk.PhotoImage(file=f"pics/item{itemno}.png")    #creates image object
...
class buypg():
    def __init__(self,itemno):
        ...
        if messagebox.askyesno("Alert",f"Do you want to purchase {pid} \nprice:{price}"):    #spawns messagebox asking if willing to quit
            ...
            alabel=tk.Label(frame,text=f"Enter your address",font="Roboto 10",bg=labelcol,fg="white")                    
            ...
            plabel=tk.Label(frame,text=f"Enter your phone number",font="Roboto 10",bg=labelcol,fg="white")                    
